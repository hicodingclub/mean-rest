...
files=(
  ...
  "/mfilegroup/mfilegroup-list/mfilegroup-list-select-index.component.css"
  "/mfilegroup/mfilegroup-list/mfilegroup-list-select-index.component.html"
  "/mfilegroup/mfilegroup-list/mfilegroup-list-select-index.component.ts"
  ...
  "/mfile/mfile-list/mfile-list-widget-galleryBottomTitle.component.html"
  "/mfile/mfile-list/mfile-list-widget-galleryBottomTitle.component.css"
  "/mfile/mfile-list/mfile-list-widget-galleryBottomTitle.component.ts"
...
echo "  1. Go to ${TARGET_DIR_FILE}/mfile/mfile-list/mfile-list-widget-galleryBottomTitle.component.html"
